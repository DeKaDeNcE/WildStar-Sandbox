public class SkyTrackCloudSet
{
    ...
    public string Model00 { get; set; }
    public string Model01 { get; set; }
    public string Model02 { get; set; }
    public string Model03 { get; set; }
    public string Model04 { get; set; }
    public string Model05 { get; set; }
    public string Model06 { get; set; }
    public string Model07 { get; set; }
    public string Model08 { get; set; }
    public string Model09 { get; set; }
