public class WorldClutter
{
    public uint Id { get; set; }
    public string Description { get; set; }
    public float Density { get; set; }
    public uint ClutterFlags { get; set; }
    public string AssetPath0 { get; set; }
    public string AssetPath01 { get; set; }
    public string AssetPath02 { get; set; }
    public string AssetPath03 { get; set; }
    public string AssetPath04 { get; set; }
    public string AssetPath05 { get; set; }
